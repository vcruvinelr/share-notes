...
def upgrade():
    ...
    subscription_status = postgresql.ENUM(
        "ACTIVE", "CANCELED", "PAST_DUE", "TRIALING", name="subscriptionstatus", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "permission_level",
            postgresql.ENUM("READ", "WRITE", "ADMIN", name="permissionlevel", create_type=False),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            server_default=sa.text("'ACTIVE'::subscriptionstatus"),
        ),
